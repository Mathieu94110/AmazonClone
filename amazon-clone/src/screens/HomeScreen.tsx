...
const HomeScreen = ({ navigation }) => {
    ...
    () =>
      navigation.setOptions({
        ...
        header: () => (
          ...
          >
            <View style={{ flexDirection: "row", marginVertical: 15, marginHorizontal: 2 }}>
              <Image
  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false}>
      ...
      <CarouselCard />
      <View>
        <Text style={styles.dealText}>Appareils électroniques pour la maison</Text>
      ...
      <View>
        <Text style={styles.dealText}> Plus de 60% de remise | équipement ménager</Text>
        <View style={styles.dealItemCont}>
          {dealData.map((data) => (
            <DealCard img={data.img} text={data.text} />
          ))}
